...
//        private void ClaimLetterEvent()
//        {
//            Pixel[] ClaimIt = new Pixel[3];
//            ClaimIt[0] = new Pixel(Color.FromArgb(255, 67, 124, 70), new Point(736, 522));
//            ClaimIt[1] = new Pixel(Color.FromArgb(255, 67, 123, 69), new Point(1135, 404));
//            ClaimIt[2] = new Pixel(Color.FromArgb(255, 64, 123, 69), new Point(1135, 535));
//            if (ClaimIt[0].IsPresent(screen, 15))
//            {
//                Click(ClaimIt[0].Point);
//                System.Threading.Thread.Sleep(100);
//            }
//            if (ClaimIt[1].IsPresent(screen, 2))
//            {
//                Click(ClaimIt[1].Point);
//                System.Threading.Thread.Sleep(100);
//            }
//            if (ClaimIt[2].IsPresent(screen, 2))
//            {
//                Click(ClaimIt[2].Point);
//                System.Threading.Thread.Sleep(100);
//            }
//        }
//    }
